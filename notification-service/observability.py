...
class CorrelationIdMiddleware(BaseHTTPMiddleware):
    """Lee 'x-correlation-id' o genera uno; lo pone en contextvar y header de respuesta.
       En caso de excepción, NO relanza: devuelve 500 JSON para evitar 'Empty reply'.
    """
...
class RequestLoggingMiddleware(BaseHTTPMiddleware):
    """Logs JSON de inicio/fin/error de cada request."""
